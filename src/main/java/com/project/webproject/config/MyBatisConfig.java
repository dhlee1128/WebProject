...
import com.project.webproject.datasource.RoutingDataSource;
...
@MapperScan(basePackages = {"com.project.webproject.dao"})
...
public class MyBatisConfig {
   ...
   @Bean
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
       ...
       sqlSessionFactoryBean.setTypeAliasesPackage("com.project.webproject.model");
